...
export function createSpatialRenderer(
  ...
  const dormantStone = new T.MeshStandardMaterial({ color: 0x151a20, roughness: 1, metalness: 0, transparent: true, opacity: .58 })
  const dormantStrata = new T.MeshStandardMaterial({ color: 0x0d1116, roughness: 1, metalness: 0, transparent: true, opacity: .48 })
